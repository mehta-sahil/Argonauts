...
export const Header = ({ isConnected, phase }) => {
  return (
    <header className="border-b border-navy-border bg-navy-dark/95 backdrop-blur-md px-6 py-4 sticky top-0 z-40 shadow-xl">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative flex items-center">
            ...
            <div className="w-9 h-9 rounded-full bg-mc-red shadow-lg shadow-mc-red/40" />
            <div className="w-9 h-9 rounded-full bg-mc-amber -ml-4 mix-blend-screen opacity-90 shadow-lg shadow-mc-amber/40" />
          </div>
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="bg-mc-red/20 text-mc-red text-[11px] font-mono px-2 py-0.5 rounded-full border border-mc-red/30">
                v1.0-LIVE
              </span>
            </div>
